          ...
          <div className="bg-white rounded-lg border p-8 text-center space-y-4">
            ...
            {me.plan !== "pro" && (
              <div className="flex justify-center gap-3">
                <UpgradeButton plan="pro_monthly" label="Pro Mensual — €199/mes" className="btn-accent" />
                <UpgradeButton plan="pro_annual" label="Pro Anual — €1.990/año" className="btn-primary" />
              </div>
            )}
          </div>
        )
