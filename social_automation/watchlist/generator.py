...
- Lead with the tickers in $SYMBOL format — all must appear prominently.
...
for today's trading session. Mention all tickers in $SYMBOL format. \
Include a short sentence of context. Body text ≤240 characters.

Return ONLY:
TEXT: <tweet body, max 240 chars, all $SYMBOLs included>
